"""
Create a Balanced Sentence-Level Split for 500 Sentences
...
def create_balanced_split(label_map, test_size=0.2, target_coverage=0.75, random_state=42):
    ...
    print("="*80)
    print("CREATING BALANCED SENTENCE-LEVEL SPLIT (500 Sentences)")
    print("="*80)
...
if __name__ == "__main__":
    ...
    np.savez(
        "balanced_sentence_split_500.npz",
        train_sentence_ids=train_ids,
        test_sentence_ids=test_ids
    )

    print("\n" + "="*80)
    print("✅ Balanced split saved to 'balanced_sentence_split_500.npz'")
    print("="*80)
